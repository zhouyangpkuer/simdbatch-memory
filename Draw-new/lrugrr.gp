...
set output "./lrugrr/speed-lrugrr.pdf"
...
plot './draw_data/speed-nine.csv' using ($3/1000000):xticlabels(1) title "LRU" lt rgb "#5060D0" fs pattern 6,\
	 '' using ($4/1000000):xticlabels(1) title "GRR" lt rgb "#00A000" fs pattern 1
...
set output "./lrugrr/99tail-lrugrr.pdf"
# Get the directory of the benchmark
unset xlabel
# set xlabel "Different flow IDs" offset 0,0,0
...
plot './draw_data/99tail-nine.csv' using (($3/(2.2))):xticlabels(1) title "LRU" lt rgb "#5060D0" fs pattern 6,\
	 '' using (($4/(2.2))):xticlabels(1) title "GRR" lt rgb "#00A000" fs pattern 1
...
set output "./lrugrr/avgtail-lrugrr.pdf"
# Get the directory of the benchmark
unset xlabel
# set xlabel "Different flow IDs" offset 0,0,0
...
plot './draw_data/avgtail-nine.csv' using (($3/(2.2))):xticlabels(1) title "LRU" lt rgb "#5060D0" fs pattern 6,\
	 '' using (($4/(2.2))):xticlabels(1) title "GRR" lt rgb "#00A000" fs pattern 1
	 # '' using (($3/(2.2))):xticlabels(1) title columnheader(3) lt rgb "#5060D0" fs pattern 0, \
...
set output "./lrugrr/latency-lrugrr.pdf"
# Get the directory of the benchmark
unset xlabel
# set xlabel "Different flow IDs" offset 0,0,0
...
plot './draw_data/avgtail-nine.csv' using ($3/2.2):($6/2.2):($3/2.2):xticlabels(1) title "LRU" lt rgb "#5060D0" fs pattern 6,\
	 '' using ($4/2.2):($7/2.2):($4/2.2):xticlabels(1) title "GRR" lt rgb "#00A000" fs pattern 1
	 # '' using (($3/(2.2))):xticlabels(1) title columnheader(3) lt rgb "#5060D0" fs pattern 0, \
