...
set output "algomem/speed-algomem.pdf"
# Get the directory of the benchmark
set xlabel "Memory usage of FlowRadar (MB)" offset 0,0,0
...
plot './draw_data/speed-algomem.csv'	using 1:($2/1000000.0) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/speed-algomem.csv'	using 1:($4/1000000.0) title 'w/ aggregator' w lp ls 2
...
set output "algomem/99tail-algomem.pdf"
# Get the directory of the benchmark
set xlabel "Memory usage of FlowRadar (MB)" offset 0,0,0
...
plot './draw_data/99tail-algomem.csv'	using 1:($2/2.2) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/99tail-algomem.csv'	using 1:($3/2.2) title 'w/ aggregator' w lp ls 2
...
set output "algomem/avgtail-algomem.pdf"
# Get the directory of the benchmark
set xlabel "Memory usage of FlowRadar (MB)" offset 0,0,0
...
plot './draw_data/avgtail-algomem.csv'	using 1:($2/2.2) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/avgtail-algomem.csv'	using 1:($3/2.2) title 'w/ aggregator' w lp ls 2
...
set output "algomem/latency-algomem.pdf"
# Get the directory of the benchmark
set xlabel "Memory usage of FlowRadar (MB)" offset 0,0,0
...
plot './draw_data/avgtail-algomem.csv'	using 1:($2/2.2) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/avgtail-algomem.csv'	using 1:($3/2.2) title 'w/ aggregator' w lp ls 2, \
     './draw_data/avgtail-algomem.csv' 	using ($1):($2/2.2):($2/2.2):($4/2.2) notitle w errorbars ls 3 lw 1,\
     './draw_data/avgtail-algomem.csv'  using ($1):($3/2.2):($3/2.2):($5/2.2) notitle w errorbars ls 2 lw 1,\
