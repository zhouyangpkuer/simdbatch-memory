...
set output "simdsize/speed-simdrownum.pdf"
...
plot './draw_data/speed-simdrownum.csv'	using 1:($2/1000000.0) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/speed-simdrownum.csv'	using 1:($4/1000000.0) title 'w/ aggregator' w lp ls 2
...
set output "simdsize/99tail-simdrownum.pdf"
# Get the directory of the benchmark
set xlabel "# K-V arrays" offset 0,0,0
...
plot './draw_data/99tail-simdrownum.csv'	using 1:($2/2.2) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/99tail-simdrownum.csv'	using 1:($3/2.2) title 'w/ aggregator' w lp ls 2
...
set output "simdsize/avgtail-simdrownum.pdf"
# Get the directory of the benchmark
set xlabel "# K-V arrays" offset 0,0,0
...
plot './draw_data/avgtail-simdrownum.csv'	using 1:($2/2.2) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/avgtail-simdrownum.csv'	using 1:($3/2.2) title 'w/ aggregator' w lp ls 2
...
set output "simdsize/latency-simdrownum.pdf"
# Get the directory of the benchmark
set xlabel "# K-V arrays" offset 0,0,0
...
plot './draw_data/avgtail-simdrownum.csv'	using 1:($2/2.2) title 'w/o aggregator' w lp ls 3, \
	 './draw_data/avgtail-simdrownum.csv'	using 1:($3/2.2) title 'w/ aggregator' w lp ls 2, \
     './draw_data/avgtail-simdrownum.csv' 	using ($1):($2/2.2):($2/2.2):($4/2.2) notitle w errorbars ls 3 lw 1,\
     './draw_data/avgtail-simdrownum.csv'   using ($1):($3/2.2):($3/2.2):($5/2.2) notitle w errorbars ls 2 lw 1,\
